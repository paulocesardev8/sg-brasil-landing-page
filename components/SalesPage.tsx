...
const ambientes = [
  { nome: "Comercial", slug: "comercial", img: "/images/comercial.webp", desc: "Resistência para alto tráfego", disponivel: false },
  { nome: "Externo",   slug: "externo",   img: "/images/externa.webp",   desc: "Antiderrapante e durável",    disponivel: false },
  { nome: "Banheiro",  slug: "banheiro",  img: "/images/banheiro.webp",  desc: "Sofisticação e higiene",      disponivel: true  },
  { nome: "Cozinha",   slug: "cozinha",   img: "/images/cozinha.webp",   desc: "Praticidade na limpeza",      disponivel: false },
  { nome: "Quarto",    slug: "quarto",    img: "/images/quarto.webp",    desc: "Aconchego premium",           disponivel: false },
];
...
{/* LOGO OFICIAL COM SOMBRA/BRILHO BRANCO */}
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center md:justify-end md:pb-16 p-4"> 
                ...
                <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-700 delay-100 flex flex-col items-center">
                  ...
                  {amb.disponivel ? (
                    <Link
                      href={`/ambientes/${amb.slug}`}
                      className="bg-[#D12018] text-white px-6 py-2 rounded-full text-xs font-bold uppercase tracking-widest hover:bg-white hover:text-[#D12018] transition-colors"
                    >
                      VER PRODUTOS
                    </Link>
                  ) : (
      ...
      <section className="py-20 px-6 bg-black">
        <div className="max-w-5xl mx-auto text-center mb-12">
          <span className="inline-block text-[#BA8213] text-xs font-bold uppercase tracking-[0.3em] mb-3">
            Catálogo Online
          </span>
          <h2 className="text-3xl md:text-5xl font-black text-white uppercase tracking-tight">
            Explore nossos <span className="text-[#D12018]">produtos</span>
          </h2>
        </div>
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Link
            href="/porcelanatos"
            className="group relative rounded-3xl overflow-hidden h-64 block"
          >
            <img
              src="/images/marmore-colecao.webp"
              alt="Porcelanatos"
              className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent" />
            <div className="absolute inset-0 flex flex-col justify-end p-8">
              <span className="text-[#BA8213] text-xs font-bold uppercase tracking-widest mb-2">Linha completa</span>
              <h3 className="text-white font-black text-2xl uppercase mb-1 group-hover:text-[#D12018] transition-colors">
                Porcelanatos
              </h3>
              <p className="text-gray-300 text-sm mb-4">Premium e Retrabalhado — qualidade com melhor preço</p>
              <span className="inline-flex items-center gap-2 text-white font-bold text-xs uppercase tracking-widest group-hover:gap-3 transition-all">
                Ver catálogo →
              </span>
            </div>
          </Link>
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent" />
            <div className="absolute inset-0 flex flex-col justify-end p-8">
              <span className="text-[#BA8213] text-xs font-bold uppercase tracking-widest mb-2">Village Cortes Especiais</span>
              <h3 className="text-white font-black text-2xl uppercase mb-1 group-hover:text-[#D12018] transition-colors">
                Nichos
              </h3>
              <p className="text-gray-300 text-sm mb-4">Embutir e sobrepor em 8 acabamentos exclusivos</p>
              <span className="inline-flex items-center gap-2 text-white font-bold text-xs uppercase tracking-widest group-hover:gap-3 transition-all">
                Ver catálogo →
              </span>
            </div>
