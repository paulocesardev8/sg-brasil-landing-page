...
import { Produto, Cor } from "@/data/produtos"
...
export default function ProdutoDetalhe({ produto }: { produto: Produto }) {
  ...
  const ambienteBack = produto.ambientes[0] ? `/ambientes/${produto.ambientes[0]}` : "/ambientes"
  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div className="sticky top-28">
          <div className="relative aspect-square rounded-3xl overflow-hidden bg-gray-100 shadow-xl">
            <Image src={produto.imagemDetalhe} alt={produto.nome} fill className="object-cover" />
      ...
      {/* VOLTAR AO AMBIENTE */}
      <section className="mt-20 pt-12 border-t border-gray-100 flex items-center justify-between">
        <h2 className="text-xl font-black text-black uppercase">
          Ver mais produtos do <span className="text-[#D12018]">ambiente</span>
        </h2>
        <Link
          href={ambienteBack}
